...
@Component({
  ...
  styleUrls: ['./changepassuser.component.scss']
})
export class ChangepassuserComponent implements OnInit {
  ...
  changePassword(passwordCurrent: string, newPassword: string, newMatchingPassword: string) {
    ...
    this.http.post('https://tiger010203.herokuapp.com/a/admin/change-password-profile', changePassword, { responseType: 'text' })
    .subscribe(
