...
@Component({
  selector: 'app-layout-public-search',
  templateUrl: './layout-public-search.component.html',
  styleUrls: ['./layout-public-search.component.css']
})
export class LayoutPublicSearchComponent implements OnInit {
private userUrl = 'https://tiger010203.herokuapp.com/position/city/name1';
  ...
  ngOnInit() {
   this.getCitys()
     ...
     //this.getPostPublic(this.id1, this.zipcode);
     //this.getAllPostPublics().subscribe(products => this.products = products);
...
public getUsers() {
  ...
  public getAllPostPublics() {
    return this.http.get<ListPostApproved[]>(this.publicAllPostUrl);
  }
